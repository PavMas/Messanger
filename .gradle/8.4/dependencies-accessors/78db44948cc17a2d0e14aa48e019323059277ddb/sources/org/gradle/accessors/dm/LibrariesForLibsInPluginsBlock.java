...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final InjectLibraryAccessors laccForInjectLibraryAccessors = new InjectLibraryAccessors(owner);
    ...
    /**
     * Returns the group of libraries at inject
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public InjectLibraryAccessors getInject() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForInjectLibraryAccessors;
    }
    ...
    public static class AnnotationLibraryAccessors extends SubDependencyFactory {
        private final AnnotationJsr250LibraryAccessors laccForAnnotationJsr250LibraryAccessors = new AnnotationJsr250LibraryAccessors(owner);

        public AnnotationLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at annotation.jsr250
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public AnnotationJsr250LibraryAccessors getJsr250() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForAnnotationJsr250LibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class AnnotationJsr250LibraryAccessors extends SubDependencyFactory {

        public AnnotationJsr250LibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for api (javax.annotation:jsr250-api)
             * This dependency was declared in catalog libs.versions.toml
         * @deprecated Will be removed in Gradle 9.0.
             */
        @Deprecated
            ...
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
                return create("annotation.jsr250.api");
        }
    ...
    public static class DaggerLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        @Deprecated
            ...
            /**
             * Creates a dependency provider for v251 (com.google.dagger:dagger)
             * This dependency was declared in catalog libs.versions.toml
         * @deprecated Will be removed in Gradle 9.0.
             */
        @Deprecated
        ...
        /**
         * Returns the group of libraries at dagger.compiler
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
    ...
    public static class DaggerCompilerLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        @Deprecated
            ...
            /**
             * Creates a dependency provider for v251 (com.google.dagger:dagger-compiler)
             * This dependency was declared in catalog libs.versions.toml
         * @deprecated Will be removed in Gradle 9.0.
             */
        @Deprecated
            public Provider<MinimalExternalModuleDependency> getV251() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
                return create("dagger.compiler.v251");
        }
     ...
     */
    @Deprecated
    public static class InjectLibraryAccessors extends SubDependencyFactory {
        private final InjectJavaxLibraryAccessors laccForInjectJavaxLibraryAccessors = new InjectJavaxLibraryAccessors(owner);

        public InjectLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at inject.javax
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public InjectJavaxLibraryAccessors getJavax() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForInjectJavaxLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class InjectJavaxLibraryAccessors extends SubDependencyFactory {

        public InjectJavaxLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        @Deprecated
            ...
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
                return create("inject.javax.inject");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: daggerCompiler (2.5.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: daggerVersion (2.5.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: javaxInjectVersion (1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getJavaxInjectVersion() { return getVersion("javaxInjectVersion"); }
            ...
            /**
             * Returns the version associated to this alias: jsr250ApiVersion (1.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getJsr250ApiVersion() { return getVersion("jsr250ApiVersion"); }
